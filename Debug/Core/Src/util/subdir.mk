...
../Core/Src/util/linalg.c \
../Core/Src/util/log.c 

OBJS += \
./Core/Src/util/fifo.o \
./Core/Src/util/linalg.o \
./Core/Src/util/log.o 

C_DEPS += \
./Core/Src/util/fifo.d \
./Core/Src/util/linalg.d \
./Core/Src/util/log.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Src/util/%.o: ../Core/Src/util/%.c Core/Src/util/subdir.mk
...
clean-Core-2f-Src-2f-util:
	-$(RM) ./Core/Src/util/fifo.d ./Core/Src/util/fifo.o ./Core/Src/util/linalg.d ./Core/Src/util/linalg.o ./Core/Src/util/log.d ./Core/Src/util/log.o
